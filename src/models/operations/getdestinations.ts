 ...
 * Successful Response
 */
export type GetDestinationsResponseBody = {
...
export type GetDestinationsResponse = {
     ...
     * Successful Response
     */
    object?: GetDestinationsResponseBody | undefined;
};
...
/** @internal */
export namespace GetDestinationsResponse$ {
    export type Inbound = {
        ContentType: string;
        StatusCode: number;
        RawResponse: Response;
        object?: GetDestinationsResponseBody$.Inbound | undefined;
    };

    export const inboundSchema: z.ZodType<GetDestinationsResponse, z.ZodTypeDef, Inbound> = z
        .object({
            ContentType: z.string(),
            StatusCode: z.number().int(),
            RawResponse: z.instanceof(Response),
            object: z.lazy(() => GetDestinationsResponseBody$.inboundSchema).optional(),
        })
        .transform((v) => {
            return {
    ...
    export type Outbound = {
        ...
        StatusCode: number;
        RawResponse: never;
        object?: GetDestinationsResponseBody$.Outbound | undefined;
    };

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetDestinationsResponse> = z
        .object({
            contentType: z.string(),
            statusCode: z.number().int(),
            ...
            object: z.lazy(() => GetDestinationsResponseBody$.outboundSchema).optional(),
        })
        .transform((v) => {
            return {
                ContentType: v.contentType,
